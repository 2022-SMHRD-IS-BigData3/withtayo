                    ...
                    <div class="container offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body" id="offcanvas-body"> <!-- Offcanvas ë´ì© -->
                            <div class="navbar-nav">
                                ...
                                <a class="nav-link active" href="#">현재 예약 정보</a>
 ...
 <!-- Optional JavaScript; choose one of the two! -->
    ...
    <div class="contentbox">
    	<div>
            ...
            function newPage()  {
              window.location.href = 'findBy.jsp';
            }
                </script>
            ...
            <b>휴대폰 번호로 찾기</b>
            <br>
            <form action="FindPwById" method="post">
            <br>
...
<c:if test="${!empty yourInfo}">
 <div class="contentbox2">
    	...
    	<table class="table">
    		...
    		<tr>
    			<td colspan="2">
    				<input type="button" value="메인으로" onclick="location.href='loggingMain.jsp'">
    			</td>
    		</tr>
