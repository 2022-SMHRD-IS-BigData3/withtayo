                    ...
                    success: function (rsps99) {
                        ...
                        for (let p = 0; p < 2; p++) {
                            $("#searchResultTable").append('<div class="instant_box" style="position: relative;"><table class="resTables" id="srchIdx'
                                ...
                                + resRsps[p].routeid + '"><span style="font-size: 12px;">남은 도착 시간</span></div><div style="font-size: 14px;  border-radius: 5px; margin-top: -10px;"><br><div style="display: flex; justify-content: center; width: 100%;"><table style="margin-left: 20px;"><tr><td style="width: 5px;"> <i class="material-icons" style="color: rgb(255, 150, 80);width: 20px;">&#xe530;</i></td><td class="dprtNode">'
                        ...
                        $.ajax({
                            ...
                            success: function (rsps88) {
                                ...
                                try {
                                    ...
                                    $("#infoIdx" + resRsps[t].routeid).html("검색된 버스 위치 실시간 추적 중");
                                    // 리스트로 뽑을 때 수정 할 것
                                    $(".favBtn").show();
                                }
                            },
