			...
			$("#cancelBtn").on("click", function(){
				$.ajax({
					...
					success : function(cancelResp){
						...
						window.location.replace("Effing-testSearch.quack");
					},
           ...
           //         });
              ...
              /*      if (dprtNodeDirection == "Ascending") {
                ...
                /*    if(dprtNodeDirection == "Ascending" && parseInt(ascBuses[targetIdx].nodeord) < dprtNodeOrder){
                    ...
                    return $.ajax({
                        url: 'Booooooook.quack', // book'em! f'ing book'em! asdkadlfjgnaldkjfg
                    ...
                    console.log(resp004);
                    window.location.replace("Effing-matching.quack");
