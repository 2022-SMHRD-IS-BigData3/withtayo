...
<body>
    <div class="container">
                    ...
                    <div class="container offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body" id="offcanvas-body"> <!-- Offcanvas 내용 -->
                            <div class="navbar-nav" style="text-align: center;">
                                ...
                                <hr>
                                <a class="nav-link active" href="DriverLogout.boom">로그아웃</a>
                            </div>
                        </div>
                    </div> <!-- Offcanvas 끝 -->
                </div>
        ...
        <div class="section big">
            ...
            <div class="businfor">
                ...
                <div class="content">
                    <!-- 비밀번호 변경 내 내용 -->
                    <form action="ChangeDriverPW.boom" method="post" class="pw">
                        <input type="text" name="d_pw" placeholder="기존 비밀번호" aria-label="기존 비밀번호"
                            aria-describedby="addon-wrapping" id="menu1"
                            style="width:300px; height:25px; font-size:15px; border:rgb(238, 235, 235) ">
                        <input type="password" name="nd_pw" placeholder="새로운 비밀번호" aria-label="변경 비밀번호"
                            aria-describedby="addon-wrapping" id="menu2"
                            style="width: 300px; height: 25px; font-size: 15px; border: rgb(238, 235, 235);">
                        <input type="password" name="nd_pw1" placeholder="새로운 비밀번호 확인" aria-label="변경 비밀번호"
                            aria-describedby="addon-wrapping" id="menu2"
                            style="width: 300px; height: 25px; font-size: 15px; border: rgb(238, 235, 235);">
                        </table>
                        <div class="pwgroup">
                ...
                <div class="content">
                    <form action="RevokeDriver.boom" method="post" style="background-color: white;">
                        <input type="password" name="d_pw" placeholder="'비밀번호'를 입력하세요" style="width:300px; height:25px; font-size:15px; border:rgb(238, 235, 235) "></input>
    ...
    <script src="https://kit.fontawesome.com/17b6c660df.js" crossorigin="anonymous">
    </script>
    <script>
