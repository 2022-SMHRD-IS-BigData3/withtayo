...
<body>
    <div class="container">
        ...
        <div class="section big">
            <!-- 중앙 컨텐츠 -->
            <div class="section_mainbusinfor">
                <table>
            ...
            <div class="section_mainbusinfor_add">
                <input style="margin-right: 15px;" id="btnr" type="button" value="취소"
                    onclick="location.href='Effing-driverLogging.boom'">
                <input style="margin-left: 15px;" id="btnl" type="button" value="확인"
                    onclick="location.href='Effing-driverMatching.boom'">
            </div>
        </div>
