...
<body>
    <div class="container">
                        ...
                        <div>
                            <form class="searchFull" id="searchArea">
                                <div class="form-group-design">
                                    ...
                                    <input type="text" class="form-control srch" id="arrival" placeholder="도착지를 입력하세요">
                                    <div class="dropdown">
                                        <div class="" id="arrvSrchDropdown"></div>
                                    </div>
                                    <div id="switchBtnArea">
                                        <button _ngcontent-isv-c99="" type="button" class="btn_switch ng-star-inserted"
                                            title="출발지/도착지 전환" id="switchBtn"></button>
                                    </div>
                                </div>
                                <div class="srchBtn" id="btnTbl">
                                    <input type="button" onclick="location.replace('Effing-testSearch.quack')"
                                        class="btn btn-secondary" value="재입력"
                                        style="background-color: rgb(192, 190, 190); border: 0;">
                                    <input type="button" id="srchBtn" disabled class="btn btn-warning" value="검색"
        ...
        <div class="endbar">
            <div class="row">
                <div class="a">
                    <img src="" alt="" id="image" style="width: 100%; height: 100%; border: solid 1px black;">
                </div>
            </div>
        </div>
    </div>
                    ...
                    success: function (rsps99) {
                        ...
                        for (let p = 0; p < 2; p++) {
                            $("#searchResultTable").append('<div class="instant_box" style="position: relative;"><table class="resTables" id="srchIdx'
                                + resRsps[p].routeid + '"><tr><td class="resRoute"><button onclick="favBtnAction($(this))" class="material-icons favBtn">&#xe83a;</button><strong>'
                                + resRsps[p].routeno + '</strong><button onclick="alarmBtnAction($(this))" class="material-icons busAlarm">&#xe7f7;</button></td><br><td class="resRouteId">'
                                + resRsps[p].routeid + '</td></tr><tr><td class="bustimetable" colspan="2"><div class="arrvTime arrvInfo" id="infoIdx'
                                + resRsps[p].routeid + '"><span style="font-size: 14px;">도착 시간 계산 중</span></div><div style="font-size: 14px;  border-radius: 5px; margin-top: -10px;"><br><div style="display: flex; justify-content: center; width: 100%;"><table style="margin-left: 20px;"><tr><td style="width: 5px;"> </td><td></td><th style="font-size: 15px;"></th><td></td><td style="width: 5px;"> </td><td></td></tr></table></div></div></td></tr></table></div><br>');
                        }
                        ...
                        $.ajax({
                            ...
                            success: function (rsps88) {
                                ...
                                try {
                                    ...
                                    $("#infoIdx" + resRsps[t].routeid).html("<span style='color:red'>" + rsps88.response.body.items.item.vehicletp + "</span> " + Math.floor(parseInt(rsps88.response.body.items.item.arrtime) / 60) + "분 뒤 도착<br>" + rsps88.response.body.items.item.arrprevstationcnt + " 정거장 남음");
        ...
        function alarmBtnAction(btn) {
            ...
            $.ajax({
                ...
                success: function (rspsEffed) {
                    ...
                    window.location.replace("Effing-booking.quack");
                },
                error: function (error) {
                    console.log(error);
                }
