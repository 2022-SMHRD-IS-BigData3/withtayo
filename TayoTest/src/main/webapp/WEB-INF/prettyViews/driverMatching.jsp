...
<body>
                    ...
                    <div class="container offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body" id="offcanvas-body"> <!-- Offcanvas 내용 -->
                            <div class="navbar-nav" style="text-align: center;">
                                ...
                                <hr>
                                <a class="nav-link active" href="Effing-driverMypage.boom">개인정보 변경</a>
                                <a class="nav-link active" href="#">고객센터</a>
                                <a class="nav-link active" href="#"></a>
                                <hr>
                                <a class="nav-link active" href="ShiftOff.boom">운행종료</a>
                            </div>
                        </div>
                    </div> <!-- Offcanvas 끝 -->
                </div>
    ...
    $("#modActivation").on("click", function(){
    	...
    	// 알람 사운드
    	let alarmSound = new Audio('./assets/bookingAlarm.wav');
    		...
    		setInterval(function(){
    			...
    			// 예약자 정류자 순번대로 도착정보 화면에 표시
    				...
    				if(resp005 == 0 || resp005 == undefined || resp005 == null){
    					...
    					console.log("NODEORD TEST//"+resp005.nodeord);
    					$("#offTheBus").attr("disabled");
    					$("#offTheBus").css("color", "lightgray");
    					...
    					// 테스트 끝 = = = == = = = = = = = = = = = = = = = = = = = = = = = = = = 
	    					...
	    					if(gotOn.length > 0){
	    						...
	    						filteredArr = bookedDprt;
	    					}
    						// dprt와 arrv 통틀어 가장 작은 숫자 : 가장 먼저 표시할 인덱스와 출발/도착지 판단
    						let dprtMin = Math.min(...filteredArr);
    						let arrvMin = Math.min(...bookedArrv); 
    						let targetDprtIdx = filteredArr.indexOf(dprtMin);
