            ...
            <div id="psngrLogWrapper">
                <div id="form-inner-container">
                    ...
                    <div id="sign-up-container">
                        <form action="PassengerLogin.quack" method="post" style="margin-top: 50px">
                            <div>
                            ...
                            <ul style="margin-left: 17px; margin-top: -5px;">
                            	<!-- 이름만 PassengerSignup임 승객, 기사 공용 -->
                                <li><a href="PassengerSignup.quack?ident=isPassenger" id="passengerJoin" style="text-decoration:none">회원가입</a>
                                </li>
                                <li><a href="Effing-findByPhone.quack" style="text-decoration:none">ID/PW찾기</a></li>
                            </ul>
                            <br>
                            ...
                            <div class="aTag" style="margin-top: 18px;">
                                <a href="Effing-driverLogging.quack" style="color: rgb(129, 128, 128);">기사님
                                    로그인</a>
                            </div>
                        </form>
                    </div>
